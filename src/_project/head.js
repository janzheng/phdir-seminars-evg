...
export const site_url = 'https://evergreen.phage.directory';
export const site_name = 'Evergreen 2021';
export const site_title = 'Evergreen 2021';
export const site_twitter = '@phagedirectory';
export const site_twitter_creator = '@yawnxyz';
export const site_color = '#DBF4E9';
...
export const head = {
  ...
  link: [
    ...
    { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Noto+Serif&family=Public+Sans:wght@400;700&display=swap' },
