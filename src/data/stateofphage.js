...
export const formData = {
  ...
  settings: {
    ...
    successText: `<div class="_center"><img class="sop-square _center _margin-bottom" alt="State of Phage Survey Logo" src="/state_of_phage_kema_sq_icon.png" /></div>
    \n\n
    \n\n ### Thanks a million!
  ...
  styles: {
    formName: '_margin-bottom-2',
    formDescription: '_divider-bottom',
    formIntro:'_margin-bottom-2',
    formletContainer: '__formletContainer _padding-left _padding-right',
    contentContainer: '_divider-bottom',
    formletFieldContainer: '_divider-bottom',
    nextButtonClasses: "__action",
    prevButtonClasses: "__outline __soft",
    pageName: "__formletPageName _margin-bottom",
    pageDescription: "__formletPageDescription _margin-bottom-2",
    successBox: "",
    resetButtonClasses: "_padding",
    pageTOC: "_card _padding __flat _md-pfix",
    surveysCompleted: "_card _padding __active",
  },
  submitHandler: (data)=> {
    ...
    fields: [
      ...
      // },
      {
        ...
        styles: {
          ...
          labelContainer: "_margin-bottom-half _md-pfix",
        }
      },
      {
        name: "email",
      ...
      },
      {
        ...
        subformlet: {
          ...
          yup: {
            ...
            validators: {
              strainSourceAmounts: yup.string(),
            },
          },
        },
      },
      {
        ...
        subformlet: {
          ...
          yup: {
            ...
            validators: {
              strainSampleSourceAmounts: yup.string(),
            },
          },
        },
      },
      ...
      },
      {
        ...
        subformlet: {
          ...
          yup: {
            ...
            validators: {
              charMethodTypesAmounts: yup.string(),
            },
          },
        },
      },
      ...
      },
      {
        ...
        subformlet: {
          ...
          yup: {
            ...
            validators: {
              phageSampleSourceAmounts: yup.string(),
            },
          },
        },
      },
  ...
  yup: {
    ...
    validators: {
      ...
      // pt2
      strainColSize: yup.string(),
      strainSources: yup.array(),
      strainSampleSources: yup.array(),
      strainList: yup.array(),
      ...
      charMethodTypes: yup.array(),
      charMethods: yup.array(),
      phageColSize: yup.string(),
      phageColActivity: yup.array(),
      difficultPhageHosts: yup.string(),
      phageSources: yup.array(),
      phageSampleSources: yup.array(),
      phageHostRange: yup.array(),

      // pt4
      toolsMethods: yup.array(),
