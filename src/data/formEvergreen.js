...
export const formData = {
  ...
  settings: {
    ...
    \n\n Here's to hoping everyone will be vaccinated, Covid will go away and everyone will be hanging out at Evergreen again this year! 
    \n\n If that doesn't happen, we'll be here to make the best of it. 
